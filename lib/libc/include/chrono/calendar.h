...
inline constexpr unsigned __days_per_month[12] = {31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
}
...
public:
    weekday() = default;
    explicit constexpr weekday(unsigned wd) noexcept : _wd(wd % 7){};

    constexpr weekday(const std::chrono::sys_days& sd) noexcept : _wd()
    {
