...
template <class ToDuration, class Rep, class Period, typename = __enable_if_is_duration<ToDuration>>
...
template <
    class ToDuration, class Rep, class Period,
...
struct duration
{
    ...
    template <class Rep2, typename = enable_if_t<is_convertible_v<Rep2, rep> &&
    ...
    template <class Rep2, class Period2,
              typename = enable_if_t<is_convertible_v<Rep2, rep> && (treat_as_floating_point_v<rep> ||
...
constexpr time_point<C, common_type_t<D1, duration<R2, P2>>> operator+(const time_point<C, D1>& pt,
