...
enum sectionFlag
{
    ...
    SHF_OS_NONCONFORMING = 0x100, /* This section requires special OS-specific processing (beyond the standard linking
                                     rules) to avoid incorrect behavior. */
...
enum dynTag
{
    ...
    DT_PLTRELSZ = 2,
    /* d_val */ /* Total size, in bytes, of the relocation entries associated with the procedure linkage table. */
    DT_PLTGOT = 3, /* d_ptr */  /* Contains an address associated with the linkage table. The specific meaning of this
    ...
    DT_SYMBOLIC = 16,
    /* ignored */ /* The presence of this dynamic table entry modifies the symbol resolution algorithm for references
                     within the library. Symbols,  defined within the library are used to resolve references before the
    ...
    DT_PLTREL = 20, /* d_val */    /* Type of relocation entry used for the procedure linkage table. The d_val member
                                      contains either DT_REL or DT_RELA. */
    DT_DEBUG = 21, /* d_ptr */     /* Reserved for debugger use. */
    DT_TEXTREL = 22, /* ignored */ /* The presence of this dynamic table entry signals that the relocation table
    ...
    DT_BIND_NOW = 24,
    /* ignored */ /* The presence of this dynamic table entry signals that the dynamic loader should process all
    ...
    DT_PREINIT_ARRAYSZ = 33, /* d_val */ /* Size in bytes of the array of pre-initialization functions pointed to by the
                                            DT_PREINIT_ARRAY entry. */
    DT_SYMTAB_SHNDX = 34, /* d_ptr */    /* Address of the SHT_SYMTAB_SHNDX section associated with the dynamic symbol
                                            table referenced by the DT_SYMTAB element. */
    DT_LOOS = 0x60000000,
    /* ignored */ /* Defines a range of dynamic table tags that are reserved for environment-specific use. */
    DT_VALRNGLO = 0x6ffffd00,
    /* ignored */ /* Defines a range of values using the d_un.d_val field of the dynamic structure.*/
    ...
    /* val */ /* Various state flags which are applied to the DT_ element immediately following. */
    ...
    /* ignored */ /* Defines a range of values using the d_un.d_ptr field of the dynamic structure.*/
    DT_GNU_HASH = 0x6ffffef5, /* ptr */ /* */
    DT_CONFIG = 0x6ffffefa,
    /* ptr */ /* The DT_STRTAB string table offset of a null-terminated string defining a configuration file. */
    DT_DEPAUDIT = 0x6ffffefb,
    /* ptr */ /* The DT_STRTAB string table offset of a null-terminated string defining one or more audit libraries. */
    DT_AUDIT = 0x6ffffefc,
    /* ptr */ /* The DT_STRTAB string table offset of a null-terminated string defining one or more audit libraries. */
    ...
    DT_RELACOUNT = 0x6ffffff9, /* val */     /* Indicates the RELATIVE relocation count, which is produced from the
                                                concatenation of all Elf32_Rela, or Elf64_Rela relocations. */
    DT_RELCOUNT = 0x6ffffffa, /* val */      /* Indicates the RELATIVE relocation count, which is produced from the
                                                concatenation of all Elf32_Rel relocations. */
    ...
    /* ignored */ /* Defines a range of dynamic table tags that are reserved for processor-specific use. */
