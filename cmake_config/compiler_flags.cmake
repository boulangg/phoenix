...
set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} "-Wall -Wextra -ffreestanding -fno-stack-protector -fno-builtin-fprintf -Wno-literal-suffix -mno-red-zone -std=c++2a -U__linux__ -D__phoenix__ -g")
