...
public:
    ...
    {
        __attribute__((section("TEST_CLASS_METADATA"))) static const TestClassMetadata metadata = {
            __PRETTY_FUNCTION__, __FILE__, __LINE__, &typeid(ThisClass)};
...
#define TEST_METHOD(TestName)                                                                                          \
    ...
    {                                                                                                                  \
        static constexpr auto __GetTestMethod_##TestName##_init __attribute__((used, section("TEST_INIT"))) =          \
            &ThisClass::__GetTestMethod_##TestName;                                                                    \
        __attribute__(                                                                                                 \
            (section("TEST_METHOD_METADATA"))) static const UnitTestFramework::TestMethodMetadata metadata = {         \
            #TestName, __PRETTY_FUNCTION__, __FILE__, __LINE__};                                                       \
        __attribute__((section("TEST_METHOD_INFO"))) static UnitTestFramework::TestMethodInfo info = {                 \
            TestMethodInfoType::TestMethod, nullptr, &metadata, __GetClassInfo()};                                     \
