...
static void fill_segment_descriptor_64(uint8_t index, uint64_t base, uint32_t limit, uint8_t flags, uint8_t sizebits)
{
...
static void fill_segment_descriptor(uint8_t index, uint32_t base, uint32_t limit, uint8_t flags, uint8_t sizebits)
{
    uint32_t p0, p1;
...
void SetupProcessor::setupGDT()
{
    ...
    fill_segment_descriptor(USER_CS_INDEX, USER_CS_BASE, USER_CS_LIMIT, USER_CS_FLAGS, USER_CS_SIZEB);
    fill_segment_descriptor(USER_DS_INDEX, USER_DS_BASE, USER_DS_LIMIT, USER_DS_FLAGS, USER_DS_SIZEB);
    fill_segment_descriptor(USER_CS_32_INDEX, USER_CS_32_BASE, USER_CS_32_LIMIT, USER_CS_FLAGS, USER_CS_32_SIZEB);
    fill_segment_descriptor(USER_DS_32_INDEX, USER_DS_32_BASE, USER_DS_32_LIMIT, USER_DS_32_FLAGS, USER_DS_32_SIZEB);
...
void SetupProcessor::setupTSS()
{
    ...
    fill_segment_descriptor_64(TSS_INDEX, TSS_BASE, TSS_LIMIT, TSS_FLAGS, TSS_SIZEB);
    set_TSS(SEL_TSS);
}
