...
constexpr std::uint16_t EXT2_SIGNATURE = 0xEF53; // ext2 signature
constexpr std::uint64_t ROOT_INODE = 2;          // root inode
...
enum ext2_file_system_state
{
    CLEAN = 1,
    ERRORS = 2
};

enum ext2_error_handling_method
{
    IGNORE_ERRO = 1,
...
enum ext2_creator_OS_system_ID
{
    LINUX = 0,
    GNU_HURD = 1,
    MASIX = 2,
...
enum ext2_optional_features_flags
{
...
enum ext2_required_feature_flags
{
    COMPRESSION = 0x01,
...
enum ext2_read_only_feature_flags
{
    SPARSE_BLOCKS = 0x01,
...
struct ext2_directory_entry_header
{
    std::uint32_t inode;
